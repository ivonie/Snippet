...
/*
    public firstScreenAdapter(Context context, int layout, Cursor c, String[] from,
                              int[] to, int flags) {
...
*/
    ...
    public firstScreenAdapter(Activity a, ArrayList<String> list) {
        activity = a;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        View v = convertView;
        if (convertView == null)
            v = inflater.inflate(R.layout.first_view, null);
